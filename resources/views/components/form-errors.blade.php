@if ($errors->any())
    <div class="bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg mb-6" x-data="{ show: true }" x-show="show">
            ...
            <div class="flex gap-3">
                ...
                <div>
                    <h3 class="text-sm font-black text-red-800 uppercase tracking-widest">
                        @choice('Erreur|Erreurs', count($errors->all()), count($errors->all()))
                    </h3>
